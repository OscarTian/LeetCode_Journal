...
- `pair`类型,与`stack`类型的`push`,`empty`,`pop`,`top`函数
- dfs递归
...
### [172. 阶乘后的零](solutions/math/172.cpp)
- 拆分因子

### [198. 打家劫舍](solutions/1d-dp/198.cpp)
- 一维动态规划

## 2026.08.09

### [3. 无重复字符的最长子串](solutions/sliding-window/003.cpp)
- 滑动窗口
- 更新数字上次出现的位置
